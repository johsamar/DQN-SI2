...
class DQN(tf.keras.Model):
    def __init__(self, in_states, h1_nodes, out_actions):
        ...
        self.fc3 = layers.Dense(h1_nodes, activation='relu')
...
class CartPoleDQL():
    ...
    network_sync_rate = 10000     # number of steps the agent takes before syncing the policy and target network
    ...
    def train(self, episodes, render=False):
        ...
        num_states = env.observation_space.shape[0] # expecting 4: position, velocity, angle, angular velocity
        ...
        for i in range(episodes):
            ...
            terminated = False      # True when agent falls or reaches goal
            ...
            while not terminated:
                ...
                if random.random() < epsilon:
                    ...
                    # select best action            
                    q_values = policy_dqn(tf.convert_to_tensor([state], dtype=tf.float32))
            ...
            if rewards > best_rewards:
                ...
                # Save policy
                policy_dqn.save_weights(f"CartPole/cartpolev6/cartpole_dql_{i}.weights.h5")
    ...
    def plot_progress(self, rewards_per_episode, epsilon_history):
        ...
        # Save plots
        plt.savefig('CartPole/cartpolev6/cartpole_dql.png')
    ...
    def test(self, episodes, model_filepath):
        ...
        for i in range(episodes):
            ...
            # Agent navigates map until it falls or reaches goal (terminated), or has taken 200 actions (truncated).
...
if __name__ == '__main__':
    cartpole = CartPoleDQL()
    #cartpole.train(150, True)
    cartpole.test(200, "CartPole/cartpolev6/cartpole_dql_25.weights.h5")
