...
class CartPoleDQL():
    ...
    def train(self, episodes, render=False):
        ...
        for i in range(episodes):
            ...
            if rewards > best_rewards:
                ...
                # Save policy
                policy_dqn.save_weights(f"CartPole/cartpolev2/cartpole_dql_{i}.weights.h5")
    ...
    def plot_progress(self, rewards_per_episode, epsilon_history):
        ...
        # Save plots
        plt.savefig('CartPole/cartpolev2/cartpole_dql.png')
...
if __name__ == '__main__':
    ...
    cartpole.test(200, "CartPole/cartpolev2/cartpole_dql_32.weights.h5")
