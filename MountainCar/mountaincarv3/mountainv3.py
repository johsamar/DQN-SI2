...
class MountainCarDQL():
    ...
    def train(self, episodes, render=False):
        ...
        for i in range(episodes):
            ...
            if rewards > best_rewards:
                ...
                print(f'Best rewards so far: {best_rewards}')
                # Save policy
                policy_dqn.save_weights(f"MountainCar/mountaincarv2/mountaincar_dql_{i}.h5")
    ...
    def plot_progress(self, rewards_per_episode, epsilon_history,i):
        ...
        # Save plots
        plt.savefig('MountainCar/mountaincarv2/mountaincar_dql.png')
...
if __name__ == '__main__':
    ...
    # mountaincar.test(10, "MountainCar/mountaincarv2/mountaincar_dql_17000.weights.h5")
